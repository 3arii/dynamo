...
# Define the main layer and flow sequence
def main_layer(dim):
...
if __name__ == '__main__':
    ...
    # Open the file for writing DTWD results
    with open('data_euclic_DTWD.txt', 'w') as f_dtwd:
        for epoch in range(nr_epochs):
            ...
            # DTWD calculation every 10 epochs
            if epoch % 10 == 0:
                with torch.no_grad():
                    iflow.eval()
                    ...
                    # Calculate DTWD
                    traj1 = data.train_data[0]
                    traj2 = data.train_data[1]
